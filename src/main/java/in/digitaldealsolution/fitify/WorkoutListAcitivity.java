...
public class WorkoutListAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_workout_list_acitivity);
        recyclerView = findViewById(R.id.workoutlist_recyclerview);
        recyclerView.setHasFixedSize(true);
        shimmerFrameLayout= findViewById(R.id.shimmerLayout_workoutList);
        shimmerFrameLayout.startShimmer();
        Toolbar myChildToolbar =
                (Toolbar) findViewById(R.id.toolbar_allworkoutlist);
    ...
    private ArrayList<ExercisesModel> filter(String text, ArrayList<ExercisesModel> exerciseslist) {
        ...
        for(ExercisesModel exercisesModel : exerciseslist){
            if(exercisesModel.getWorkout()!=null) {
    ...
    private void PutDataIntoRecyclerView(ArrayList<ExercisesModel> exerciseslist) {
        ArrayList<ExercisesModel> filterList = new ArrayList<>();
        filterList = filter(workoutName,exerciseslist);
